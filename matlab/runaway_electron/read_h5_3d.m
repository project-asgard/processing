...
xi = create_grid(degree, level, domain_s);
size_dset = size(dset);
n = 2^level*degree;
...
figure(i)
this_data = reshape(dset(:,i),n,n,n);
slice1 = reshape(this_data(12,:,:),n,n);
slice2 = reshape(this_data(:,12,:),n,n);
slice3 = reshape(this_data(:,:,12),n,n);
figure(1)
h = pcolor(slice1)
